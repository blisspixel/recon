...
- This submission freeze local proof reruns the public synthetic and
  ...
  archive, does not claim an OpenSSF badge, and does not claim outside
  replication.
...
list, and posture distributions that require a caller-supplied domain list
remain out of this memo by design.
