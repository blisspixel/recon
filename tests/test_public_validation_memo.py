...
MEMOS = (
    ROOT / "validation" / "2026-06-19-paper-reproduction-smoke.md",
    ROOT / "validation" / "2026-06-28-hybrid-interval-smoke.md",
)
...
def test_public_paper_reproduction_smoke_memo_passes_validation_hygiene() -> None:
    violations = find_violations(ROOT, [str(memo.relative_to(ROOT)) for memo in MEMOS])
