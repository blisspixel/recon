...
Schema-pinned portable packaging candidate for recon-tool 2.17.10. It
...
[representative-client evaluation](https://github.com/blisspixel/recon/blob/v2.17.10/docs/agent-portability-evaluation-declaration.md).
