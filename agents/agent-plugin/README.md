...
Schema-pinned portable packaging candidate for recon-tool 2.16.0. It
...
[representative-client evaluation](https://github.com/blisspixel/recon/blob/v2.16.0/docs/agent-portability-evaluation-declaration.md).
