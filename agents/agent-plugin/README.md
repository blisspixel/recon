...
Schema-pinned portable packaging candidate for recon-tool 2.14.0. It
...
[representative-client evaluation](https://github.com/blisspixel/recon/blob/v2.14.0/docs/agent-portability-evaluation-declaration.md).
