...
Schema-pinned portable packaging candidate for recon-tool 2.18.0. It
...
[representative-client evaluation](https://github.com/blisspixel/recon/blob/v2.18.0/docs/agent-portability-evaluation-declaration.md).
