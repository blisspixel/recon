...
Schema-pinned portable packaging candidate for recon-tool 2.17.13. It
...
[representative-client evaluation](https://github.com/blisspixel/recon/blob/v2.17.13/docs/agent-portability-evaluation-declaration.md).
