...
Schema-pinned portable packaging candidate for recon-tool 2.16.1. It
...
[representative-client evaluation](https://github.com/blisspixel/recon/blob/v2.16.1/docs/agent-portability-evaluation-declaration.md).
