...
Schema-pinned portable packaging candidate for recon-tool 2.17.12. It
...
[representative-client evaluation](https://github.com/blisspixel/recon/blob/v2.17.12/docs/agent-portability-evaluation-declaration.md).
