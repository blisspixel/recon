...
Schema-pinned portable packaging candidate for recon-tool 2.19.5. It
...
[representative-client evaluation](https://github.com/blisspixel/recon/blob/v2.19.5/docs/agent-portability-evaluation-declaration.md).
