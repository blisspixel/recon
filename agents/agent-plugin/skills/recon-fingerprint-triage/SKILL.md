...
license: Apache-2.0
compatibility: Requires recon-tool 2.19.3 or a compatible v2 release and Python 3.11+. Use connected MCP tools or a shell with recon on PATH. Live lookups require public network access. Catalog patching and tests require a separate recon source checkout.
metadata:
  author: blisspixel
  version: 2.19.3
---
...
round protocol in [`docs/catalog-strategy.md`](https://github.com/blisspixel/recon/blob/v2.19.3/docs/catalog-strategy.md). Keep these dimensions separate:
...
1. **Exact rule shape.** Name the exact supported record type and the narrowest
   ...
   type-specific grammar documented in [`docs/fingerprints.md`](https://github.com/blisspixel/recon/blob/v2.19.3/docs/fingerprints.md).
...
type-specific grammar in [`docs/fingerprints.md`](https://github.com/blisspixel/recon/blob/v2.19.3/docs/fingerprints.md). A typical proposal is:
