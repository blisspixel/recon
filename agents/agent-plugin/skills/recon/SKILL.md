...
license: Apache-2.0
compatibility: Requires recon-tool 2.18.1 or a compatible v2 release and Python 3.11+. Live lookups require public network access; MCP launch requires recon on PATH.
metadata:
  author: blisspixel
  version: 2.18.1
---
...
2. Reply with a 3-line headline only (field names per the stable v2.0 contract in [`docs/recon-schema.json`](https://github.com/blisspixel/recon/blob/v2.18.1/docs/recon-schema.json)):
