...
license: Apache-2.0
compatibility: 'Requires recon-tool 2.19.5 or a compatible v2 release and Python 3.11+. Use connected MCP tools or a shell with recon on PATH. Live lookups require public network access. '
metadata:
  author: blisspixel
  version: 2.19.5
---
...
2. Reply with a 3-line headline only (field names per the stable v2.0 contract in [`docs/recon-schema.json`](https://github.com/blisspixel/recon/blob/v2.19.5/docs/recon-schema.json)):
