...
2. Reply with a 3-line headline only (field names per the stable v2.0 contract in [`docs/recon-schema.json`](https://github.com/blisspixel/recon/blob/v2.15.0/docs/recon-schema.json)):
