...
REQUIRED_BOUNDARIES: tuple[tuple[str, str], ...] = (
    ...
    ("external-plan", "most recent final claim audit is the historical June 29 record"),
    ("external-plan", "current draft unfrozen"),
...
DOC_PATHS: dict[str, str] = {
    ...
    "submission-freeze": "docs/submission-freeze-checklist.md",
    "archive-readiness": "docs/archive-readiness.md",
    "replication-runbook": "docs/replication-runbook.md",
