...
SPECIAL_SCHEMA_SOURCES: Mapping[str, str] = {
    ...
    "connection_map": "formatter-derived grouped connection map from services and related domains",
...
INTENTIONAL_TENANTINFO_OMISSIONS: Mapping[str, str] = {
    ...
    "unclassified_dns_observations": "opt-in private catalog diagnostic, excluded from the stable schema",
}
