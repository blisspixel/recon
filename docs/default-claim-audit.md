...
- generated agent-guidance sections, excluding fenced examples and front
  matter, including the repository-only corpus-planning and catalog-round skills;
...
The static agent-guidance family also owns every section of the repository-only
corpus-planning and catalog-round skills. These instructions keep offline
planning and existing-artifact review distinct from requested collection,
preserve private artifacts and untouched holdouts, and require independent
...
At the 2026-09-13 checkpoint, the inventory contains 29 families and covers 136
