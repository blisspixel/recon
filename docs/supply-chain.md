...
- Remote release readiness checks PyPI's latest `recon-tool` version and the
  ...
  It also downloads the GitHub Release wheel and sdist and runs
  `gh attestation verify` against both artifacts.
...
The 2026-06-29 Scorecard recheck reports score `7.5` with the code-owned
