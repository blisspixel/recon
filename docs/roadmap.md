...
> **Status:** v2.9.0 is current. The stable baseline is complete: recon ships a
...
than scores. Hardening guidance and the exposure index still have incomplete
lineage. Static MCP and
