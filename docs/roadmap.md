...
> **Status (2026-06):** v2.2.6 is the current release (shipped 2026-06-17 to
...
> (`recon batch --summary`), and the v2.1.x through v2.2.6 hardening, security,
...
- **2.3+ (no surface currently queued).** The next minor waits for the next
  ...
  Recent patch-level work (post-2.2.0, shipped through 2.2.6): input is now
  ...
  fixes have shipped as hardening rather than new surface.
