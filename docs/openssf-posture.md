...
- Scorecard commit checked: `5b8494f4c8608e63a84b30cdbc242e05608e2be1`.
...
| `CII-Best-Practices` | No OpenSSF Best Practices Badge project is linked. | Complete the Best Practices Badge questionnaire at `bestpractices.dev`; link a badge only after the project page exists and the answers match the repository. |
...
The OpenSSF Best Practices Badge criteria are organized around basics, change
control, reporting, quality, security, and analysis. recon already has local
evidence for most passing-level questions:
...
exists on `bestpractices.dev` and the questionnaire is answered honestly. A
future badge link must point to the real project page and must not be added as
a placeholder.
